...
const CONTACT_LINKS = {
  ...
  linkedin:
    'https://www.linkedin.com/in/wasana-wickramaarachchi-9517a7396/',
...
export default function Contact() {
  ...
  return (
    <section
      ...
      style={{
        background:
          'linear-gradient(180deg,#071430 0%,#04203a 50%,#021428 100%)',
      }}
    >
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {cards.map(
            ({ id, Icon, title, description, href, external }) => (
              <a
                key={id}
                href={href}
      ...
      <button
        ...
        onClick={scrollToTop}
        className={`fixed bottom-6 right-6 z-50 w-12 h-12 rounded-full flex items-center justify-center text-white transition transform ${
          showTop
